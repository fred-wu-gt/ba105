...
<table id="table-1">
   <tr><td><h3>Ord_Det: Home</h3><h4>( MVC )</h4></td></tr>
</table>

<p>This is the Home page for Ord_Det: Home</p>
...
<ul>
  <li><a href='listAllOrd_det.jsp'>List</a> all Order_Det. <br><br></li>
...
<!--   <li> -->
<%--      <FORM METHOD="post" ACTION="<%=request.getContextPath() %>/front-end/Ord_Mas/select_page.jsp" > --%>
<!--        <b>選擇商品名稱:</b> -->
