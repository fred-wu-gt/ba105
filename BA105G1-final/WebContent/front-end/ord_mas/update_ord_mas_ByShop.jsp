...
<%-- 					<td>${ord_masvo.ord_sta}</td> --%>
					<td>
						...
						<option value="商家取消訂單">商家取消訂單</option>
						</select>					
					</td>
				</tr>
				<tr>
		...
		<input type="hidden" name="ord_rec" value="${ord_masvo.ord_rec}">
		<input type="hidden" name="ord_adr" value="${ord_masvo.ord_adr}">
		<input type="hidden" name="ord_tel" value="${ord_masvo.ord_tel}">
