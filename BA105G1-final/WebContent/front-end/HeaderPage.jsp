...
<div  class="modal fade" id="loginModal">
	<div class="modal-dialog">
		<div class="modal-content ">
			<div role="tabpanel" styl="z-index:1060">
			    <!-- 標籤面板：標籤區 -->
			    ...
			    <div class="tab-content">
			        <div role="tabpanel" class="tab-pane active " id="m_tab1"><!-- 一般會員區塊開始  -->
						...
						<input type="button" id="MEM1btn" style="text-align:right;background-color:lightyellow;margin-bottom:5px" value="MEM1">
						<input type="button" id="MEM2btn" style="text-align:right;background-color:lightyellow;margin-bottom:5px" value="MEM2">
						<script type="text/javascript">
			    		$(function(){

							$("#MEM1btn").click(function(){
				    			$("#loginMem_id").val("MEM1");
				    			$("#loginMem_psw").val("PSW1");
				    			
				    		});
							$("#MEM2btn").click(function(){
				    			$("#loginMem_id").val("MEM2");
				    			$("#loginMem_psw").val("PSW2");
			        ...
			        <div role="tabpanel" class="tab-pane" id="m_tab2"><!-- 商家區塊開始  -->
						...
						<input type="button" id="SHOP01btn" style="text-align:right;background-color:lightyellow;margin-bottom:5px" value="SHOP01">
						<script type="text/javascript">
						$(function(){

				    		$("#SHOP01btn").click(function(){
				    			$("#loginShop_id").val("SHOP01");
				    			$("#loginShop_psw").val("SHOP01");
									...
									<tr>
										<td>
											<h4 id="sayHi">
												<c:if test="${not empty loginMemberVO}">
													Hi! <span style="color:#ac04c1"><b>${loginMemberVO.mem_name}</b></span><br>今天吃水果了嗎?
												</c:if>
												<c:if test="${not empty loginShopVO}">
													Hi! <span style="color:#ac04c1"><b>${loginShopVO.shop_name}</b></span><br>今天吃水果了嗎?
												</c:if>
												<c:if test="${empty loginMemberVO && empty loginShopVO && not empty loginManagerVO}">
													Hi! 果書後台管理員<br><span style="color:#ac04c1"><b>${loginManagerVO.man_name}</b></span>
												</c:if>
											</h4>
										</td>
									</tr>
