...
@WebServlet("/DBGifReader_v4_pic2XX.do")
public class DBGifReader_v4_pic2 extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			if (rs.next()) {
				BufferedInputStream in = new BufferedInputStream(rs.getBinaryStream("COM_PIC2"));	 ////中文處理			 
