...
public class DBGifReader_v4_pic1 extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			String comCol = req.getParameter("comCol");
			String com_no2 = new String(com_no.getBytes("ISO-8859-1"),"UTF-8");
			String comCol2 = new String(comCol.getBytes("ISO-8859-1"),"UTF-8");
			ResultSet rs = stmt.executeQuery(
				"SELECT "+comCol2+" FROM COMMODITY WHERE COM_NO ='"+com_no2+"'");
	
			if (rs.next()) {
				BufferedInputStream in = new BufferedInputStream(rs.getBinaryStream(comCol2));	 ////中文處理			 
